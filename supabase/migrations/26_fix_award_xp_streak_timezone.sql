-- Migration 26: Fix award_xp streak and timezone logic
...
BEGIN
    ...
    -- 4. Streak logic based ONLY on END_DAY / EVENING_RITUAL and last_ritual_completed_at
    ...
    ON CONFLICT (user_id, date) DO UPDATE SET
        ...
        updated_at = EXCLUDED.day_ended_at
    ;
